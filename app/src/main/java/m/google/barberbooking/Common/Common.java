package m.google.barberbooking.Common;
...
public class Common {
    ...
    public static int step = 0; //init step first 0
    public static String city = "";
    public static Barber currentBarber;
    public static String DISABLE_TAG="DISABLE";
    public static int currentTimeSlot= -1;
    public static Calendar bookingDate = Calendar.getInstance();
    public static SimpleDateFormat simpleDateFormt = new SimpleDateFormat("dd_MM_yyyy");
    ...
    public static String formatShopping(String name) {
